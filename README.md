...
Here, we present Mule, a single-cell causal modeling framework that redefines SNVs as endogenous perturbations of cellular state. By quantifying mutation-induced displacement in transcriptomic space, Mule directly measures functional impact and uncovers the dynamic roles of individual SNVs throughout the spatiotemporal evolution of tumors.

<div align=center><img src="https://github.com/PSSUN/MuleDoc/blob/main/docs/_static/Figure-1.png" height = "500"/></div>
<br>

Please see [Mule Documents](https://muledoc.readthedocs.io/en/latest/index.html) for detail.
